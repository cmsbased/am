...
<form method="post" action="{routePath('login-validate')}"
    class="flex items-center justify-center h-screen bg-center bg-cover login-form bg-[url('/templates/am-dark/img/bg-dark.jpg')]"
    role="form">
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-3xl">
        ...
        <div class="py-10 rounded-md shadow-xl bg-gray-950 px-36">
